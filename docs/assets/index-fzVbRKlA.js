(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function i(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(r){if(r.ep)return;r.ep=!0;const s=i(r);fetch(r.href,s)}})();function I(t){const e=t.startsWith("/")?t:`/${t}`;return e==="/"?"/LushaiTravels/":`${"/LushaiTravels/".replace(/\/$/,"")}${e}`}function O(t){const e="/LushaiTravels/".replace(/\/$/,"");return e?t===e||t===`${e}/`?"/":t.startsWith(`${e}/`)?t.slice(e.length)||"/":t||"/":t||"/"}const k={get:t=>{try{return JSON.parse(localStorage.getItem(t))}catch{return null}},set:(t,e)=>localStorage.setItem(t,JSON.stringify(e)),remove:t=>localStorage.removeItem(t)};function A(){return k.get("lt_user")}function ie(t){k.set("lt_user",t)}function te(){k.remove("lt_user"),window.router.navigate("/")}function _(){return!!A()}function Be(t){var a;const e=k.get("lt_users")||[];if(e.find(r=>r.email===t.email))throw new Error("Email already registered");const i={...t,id:Date.now(),role:"user",createdAt:new Date().toISOString(),avatar:(a=t.fullName)==null?void 0:a.charAt(0).toUpperCase()};return e.push(i),k.set("lt_users",e),ie(i),i}function ae(t){var r;const e=k.get("lt_users")||[];if(e.find(s=>s.email===t.email))throw new Error("Email already registered");const i={...t,id:Date.now(),role:"host",status:"pending",createdAt:new Date().toISOString(),avatar:(r=t.name)==null?void 0:r.charAt(0).toUpperCase()};e.push(i),k.set("lt_users",e);const a=k.get("lt_listings")||[];return a.push({...t.listing,hostId:i.id,status:"pending",id:`listing-${Date.now()}`}),k.set("lt_listings",a),ie(i),i}function Te(t,e){const a=(k.get("lt_users")||[]).find(r=>r.email===t&&r.password===e);if(!a)throw new Error("Invalid email or password");return ie(a),a}function Z(t){return(k.get("lt_reviews")||[]).filter(i=>i.listingId===t)}function fe(t){const e=k.get("lt_reviews")||[],i={...t,id:Date.now(),createdAt:new Date().toISOString()};return e.unshift(i),k.set("lt_reviews",e),i}function Me(t){const e=k.get("lt_bookings")||[],i={...t,id:`LT-${Date.now()}`,status:"confirmed",createdAt:new Date().toISOString()};return e.unshift(i),k.set("lt_bookings",e),k.set("lt_last_booking",i),i}function Ae(){const t=A();return t?(k.get("lt_bookings")||[]).filter(i=>i.userId===t.id):[]}function Pe(){return k.get("lt_last_booking")}function se(){return k.get("lt_wishlist")||[]}function be(t){const e=se(),i=e.indexOf(t);return i===-1?e.push(t):e.splice(i,1),k.set("lt_wishlist",e),e.includes(t)}function xe(t){return se().includes(t)}function u(t,e="",i="success"){let a=document.querySelector(".toast");a||(a=document.createElement("div"),a.className="toast",document.body.appendChild(a)),a.className=`toast ${i}`,a.innerHTML=`<div class="toast-title">${i==="success"?"✅":"❌"} ${t}</div>${e?`<div class="toast-msg">${e}</div>`:""}`,a.classList.add("show"),setTimeout(()=>a.classList.remove("show"),4e3)}function S(t){return Array.from({length:5},(e,i)=>`<span style="color:${i<Math.round(t)?"#fbbf24":"#334155"};font-size:0.9rem">★</span>`).join("")}function we(t){return t.length?(t.reduce((e,i)=>e+i.rating,0)/t.length).toFixed(1):0}function de(){window.scrollTo({top:0,behavior:"smooth"})}function ce(){var s,o,d;const t=document.getElementById("navbar-container"),e=A(),i=I;t.innerHTML=`
  ...
  `,window.addEventListener("scroll",()=>{var n;(n=document.getElementById("navbar"))==null||n.classList.toggle("scrolled",window.scrollY>30)}),(s=document.getElementById("hamburger"))==null||s.addEventListener("click",()=>{var n;(n=document.getElementById("mobile-menu"))==null||n.classList.toggle("open")}),(o=document.getElementById("nav-user-btn"))==null||o.addEventListener("click",()=>{var c;const n=document.createElement("div");n.style.cssText="position:fixed;top:70px;right:24px;background:var(--bg2);border:1px solid var(--glass-border);border-radius:var(--radius);padding:8px;z-index:2000;min-width:180px;animation:fadeIn 0.2s ease",n.innerHTML=`
    ...
    `,document.body.appendChild(n),n.querySelectorAll("[data-link]").forEach(p=>{p.addEventListener("click",m=>{m.preventDefault(),window.router.navigate(p.getAttribute("href")),n.remove()})}),setTimeout(()=>document.addEventListener("click",()=>n.remove(),{once:!0}),100),(c=n.querySelector("#dd-logout"))==null||c.addEventListener("click",()=>{te()})}),(d=document.getElementById("mobile-logout"))==null||d.addEventListener("click",n=>{n.preventDefault(),te()});const a=O(location.pathname);document.querySelectorAll(".nav-links a, .mobile-menu a").forEach(n=>{const c=n.getAttribute("href");if(!c||c==="#")return;O(new URL(c,window.location.origin).pathname)===a&&n.classList.add("active")})}function He(){const t=document.getElementById("footer-container"),e=I;t.innerHTML=`
    <footer id="footer">
      <div class="container">
  ...
  `}function Ge(){const t=document.querySelector(".hero-bg");if(t){const e="/LushaiTravels/".replace(/\/$/,"");t.style.backgroundImage=`url('${e}/images/digilife-siaha-2cM78THYc4w-unsplash.jpg')`}document.querySelectorAll("[data-href]").forEach(e=>{e.addEventListener("click",()=>window.router.navigate(e.dataset.href))}),je(async()=>{const{stays:e}=await Promise.resolve().then(()=>_e);return{stays:e}},void 0).then(({stays:e})=>{const i=document.getElementById("home-stays-grid");i&&(i.innerHTML=e.slice(0,3).map(a=>`
  ...
  `}function st(t){var c,p,m,v,x,b,y;const e=P.find(g=>g.id===t);if(!e)return;const i=new Date,a=new Date(i);a.setDate(a.getDate()+1);const r=g=>g.toISOString().split("T")[0],s=document.getElementById("checkin-date"),o=document.getElementById("checkout-date");s&&(s.value=r(i)),o&&(o.value=r(a));const d=()=>{const g=new Date(s==null?void 0:s.value),h=new Date(o==null?void 0:o.value),w=Math.max(1,Math.round((h-g)/864e5)),$=w*e.price,E=document.getElementById("price-breakdown");E&&(E.innerHTML=`
  ...
  `}function $e(){return Array.from({length:W},(t,e)=>{const i=e+1;return`
    ...
    `}).join("")}function Ee(t){switch(t){case 1:return`
      ...
      </label>`}}function Lt(t){var e,i,a,r,s,o,d,n,c,p,m,v,x,b,y,g,h,w,$,E,z,B,M,C,j,R,q,D,V;switch(t){case 1:l.name=(i=(e=document.getElementById("h-name"))==null?void 0:e.value)==null?void 0:i.trim(),l.email=(r=(a=document.getElementById("h-email"))==null?void 0:a.value)==null?void 0:r.trim(),l.phone=(o=(s=document.getElementById("h-phone"))==null?void 0:s.value)==null?void 0:o.trim(),l.password=(d=document.getElementById("h-password"))==null?void 0:d.value;const Y=(n=document.getElementById("h-confirm"))==null?void 0:n.value;return!l.name||!l.email||!l.phone||!l.password?(u("Please fill all required fields","","error"),!1):l.password!==Y?(u("Passwords do not match","","error"),!1):l.password.length<8?(u("Password must be 8+ characters","","error"),!1):!0;case 2:return l.propName=(p=(c=document.getElementById("h-prop-name"))==null?void 0:c.value)==null?void 0:p.trim(),l.propType=(m=document.querySelector('input[name="prop-type"]:checked'))==null?void 0:m.value,l.address=(x=(v=document.getElementById("h-address"))==null?void 0:v.value)==null?void 0:x.trim(),l.district=(b=document.getElementById("h-district"))==null?void 0:b.value,l.mapsLink=(g=(y=document.getElementById("h-maps"))==null?void 0:y.value)==null?void 0:g.trim(),!l.propName||!l.propType||!l.address||!l.district?(u("Please fill all required fields","","error"),!1):!0;case 3:return l.rooms=(h=document.getElementById("h-rooms"))==null?void 0:h.value,l.maxGuests=(w=document.getElementById("h-guests"))==null?void 0:w.value,l.price=($=document.getElementById("h-price"))==null?void 0:$.value,l.amenities=[...document.querySelectorAll('input[name="amenity"]:checked')].map(G=>G.value),l.description=(z=(E=document.getElementById("h-description"))==null?void 0:E.value)==null?void 0:z.trim(),l.nearby=(M=(B=document.getElementById("h-nearby"))==null?void 0:B.value)==null?void 0:M.trim(),!l.rooms||!l.maxGuests||!l.price||!l.description?(u("Please fill all required fields","","error"),!1):!0;case 4:return H.length<3?(u("Please upload at least 3 photos","","error"),!1):(l.images=H,!0);case 5:return l.checkIn=(C=document.getElementById("h-checkin"))==null?void 0:C.value,l.checkOut=(j=document.getElementById("h-checkout"))==null?void 0:j.value,l.rules=(q=(R=document.getElementById("h-rules"))==null?void 0:R.value)==null?void 0:q.trim(),l.cancellation=(D=document.getElementById("h-cancel"))==null?void 0:D.value,(V=document.getElementById("h-agree"))!=null&&V.checked?!0:(u("Please agree to Terms & Conditions","","error"),!1)}}function ue(t){T=t,document.getElementById("stepper").innerHTML=$e(),document.getElementById("step-container").innerHTML=Ee(t),document.getElementById("prev-btn").style.visibility=t===1?"hidden":"visible",document.getElementById("next-btn").textContent=t===W?"🚀 Submit Listing":"Next →",Le(t),window.scrollTo({top:0,behavior:"smooth"})}function Le(t){var e;t===4&&((e=document.getElementById("photo-input"))==null||e.addEventListener("change",i=>{[...i.target.files].forEach(r=>{const s=new FileReader;s.onload=o=>{var m;H.push(o.target.result);const d=document.getElementById("photo-preview"),n=document.getElementById("photo-count"),c=document.createElement("div");c.className="upload-img-wrap";const p=H.length-1;c.innerHTML=`<img src="${o.target.result}" alt="upload" />${p===0?'<div style="position:absolute;bottom:4px;left:4px;background:rgba(16,185,129,0.9);color:#fff;font-size:0.65rem;padding:2px 6px;border-radius:4px;font-weight:700">COVER</div>':""}<button class="remove-img" data-idx="${p}">✕</button>`,d==null||d.appendChild(c),n&&(n.textContent=H.length+" photo(s) uploaded"),(m=c.querySelector(".remove-img"))==null||m.addEventListener("click",v=>{H.splice(p,1),c.remove(),n&&(n.textContent=H.length+" photo(s) uploaded")})},s.readAsDataURL(r)})}))}function ze(){var t,e;H=[],Le(1),(t=document.getElementById("next-btn"))==null||t.addEventListener("click",()=>{var i,a;Lt(T)&&(T===W?zt():(ue(T+1),(i=document.getElementById("next-btn"))==null||i.addEventListener("click",()=>{}),(a=document.getElementById("prev-btn"))==null||a.addEventListener("click",()=>{}),ze()))}),(e=document.getElementById("prev-btn"))==null||e.addEventListener("click",()=>{T>1&&ue(T-1)})}function zt(){var t,e;try{ae({name:l.name,email:l.email,phone:l.phone,password:l.password,avatar:(t=l.name)==null?void 0:t.charAt(0).toUpperCase(),listing:{name:l.propName,type:l.propType,address:l.address,district:l.district,rooms:l.rooms,maxGuests:l.maxGuests,price:l.price,amenities:l.amenities,description:l.description,images:l.images,checkIn:l.checkIn,checkOut:l.checkOut,rules:(e=l.rules)==null?void 0:e.split(`
`).filter(Boolean),cancellation:l.cancellation}}),T=1,H=[],u("Listing submitted for review! 🎉","We'll review within 48 hours."),setTimeout(()=>window.router.navigate("/host-dashboard"),800)}catch(i){u(i.message,"","error")}}let F=[];function It(){return`
    <div style="min-height:100vh;padding:100px 24px 60px;background:linear-gradient(135deg,var(--bg) 0%,var(--bg2) 50%,var(--bg3) 100%)">
  ...
  `}function St(){var t,e;F=[],(t=document.getElementById("g-photos"))==null||t.addEventListener("change",i=>{[...i.target.files].forEach(a=>{const r=new FileReader;r.onload=s=>{var n,c;F.push(s.target.result);const o=document.createElement("div");o.className="upload-img-wrap";const d=F.length-1;o.innerHTML=`<img src="${s.target.result}" alt="upload" />${d===0?'<div style="position:absolute;bottom:4px;left:4px;background:rgba(16,185,129,0.9);color:#fff;font-size:0.65rem;padding:2px 6px;border-radius:4px;font-weight:700">PROFILE</div>':""}<button class="remove-img">✕</button>`,(n=document.getElementById("g-photo-preview"))==null||n.appendChild(o),(c=o.querySelector(".remove-img"))==null||c.addEventListener("click",()=>{F.splice(d,1),o.remove()})},r.readAsDataURL(a)})}),(e=document.getElementById("submit-guide-btn"))==null||e.addEventListener("click",()=>{var b,y,g,h,w,$,E,z,B,M,C,j,R,q,D,V,Y;const i=(y=(b=document.getElementById("g-name"))==null?void 0:b.value)==null?void 0:y.trim(),a=(h=(g=document.getElementById("g-email"))==null?void 0:g.value)==null?void 0:h.trim(),r=($=(w=document.getElementById("g-phone"))==null?void 0:w.value)==null?void 0:$.trim(),s=(E=document.getElementById("g-password"))==null?void 0:E.value,o=(B=(z=document.getElementById("g-title"))==null?void 0:z.value)==null?void 0:B.trim(),d=(C=(M=document.getElementById("g-bio"))==null?void 0:M.value)==null?void 0:C.trim(),n=(j=document.getElementById("g-price"))==null?void 0:j.value,c=(R=document.getElementById("g-location"))==null?void 0:R.value,p=(q=document.getElementById("g-exp"))==null?void 0:q.value,m=[...document.querySelectorAll('input[name="g-lang"]:checked')].map(G=>G.value),v=[...document.querySelectorAll('input[name="g-spec"]:checked')].map(G=>G.value),x=(V=(D=document.getElementById("g-certs"))==null?void 0:D.value)==null?void 0:V.split(`
`).filter(Boolean);if(!i||!a||!r||!s||!o||!d||!n||!c||!p||!m.length||!v.length){u("Please fill all required fields","","error");return}if(!((Y=document.getElementById("g-agree"))!=null&&Y.checked)){u("Please agree to Terms","","error");return}try{ae({name:i,email:a,phone:r,password:s,avatar:i.charAt(0).toUpperCase(),listing:{type:"guide",title:o,experience:p,languages:m,specialties:v,price:n,location:c,bio:d,certifications:x,images:F}}),u("Guide application submitted! 🎉","We'll review within 48 hours."),setTimeout(()=>window.router.navigate("/host-dashboard"),800)}catch(G){u(G.message,"","error")}})}function Bt(){return`
    <div style="min-height:100vh;padding:100px 24px 60px;background:linear-gradient(135deg,var(--bg) 0%,var(--bg2) 50%,var(--bg3) 100%)">
      <div style="max-width:680px;margin:0 auto">
        <div style="text-align:center;margin-bottom:40px">
          <div class="auth-logo" style="font-size:2rem;margin-bottom:8px">LushaiTrips</div>
