(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function i(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(r){if(r.ep)return;r.ep=!0;const s=i(r);fetch(r.href,s)}})();function I(t){const e=t.startsWith("/")?t:`/${t}`;return e==="/"?"/LushaiTravels/":`${"/LushaiTravels/".replace(/\/$/,"")}${e}`}function _(t){const e="/LushaiTravels/".replace(/\/$/,"");return e?t===e||t===`${e}/`?"/":t.startsWith(`${e}/`)?t.slice(e.length)||"/":t||"/":t||"/"}const k={get:t=>{try{return JSON.parse(localStorage.getItem(t))}catch{return null}},set:(t,e)=>localStorage.setItem(t,JSON.stringify(e)),remove:t=>localStorage.removeItem(t)};function C(){return k.get("lt_user")}function ie(t){k.set("lt_user",t)}function te(){k.remove("lt_user"),window.router.navigate("/")}function Y(){return!!C()}function Be(t){var a;const e=k.get("lt_users")||[];if(e.find(r=>r.email===t.email))throw new Error("Email already registered");const i={...t,id:Date.now(),role:"user",createdAt:new Date().toISOString(),avatar:(a=t.fullName)==null?void 0:a.charAt(0).toUpperCase()};return e.push(i),k.set("lt_users",e),ie(i),i}function ae(t){var r;const e=k.get("lt_users")||[];if(e.find(s=>s.email===t.email))throw new Error("Email already registered");const i={...t,id:Date.now(),role:"host",status:"pending",createdAt:new Date().toISOString(),avatar:(r=t.name)==null?void 0:r.charAt(0).toUpperCase()};e.push(i),k.set("lt_users",e);const a=k.get("lt_listings")||[];return a.push({...t.listing,hostId:i.id,status:"pending",id:`listing-${Date.now()}`}),k.set("lt_listings",a),ie(i),i}function Te(t,e){const a=(k.get("lt_users")||[]).find(r=>r.email===t&&r.password===e);if(!a)throw new Error("Invalid email or password");return ie(a),a}function Z(t){return(k.get("lt_reviews")||[]).filter(i=>i.listingId===t)}function fe(t){const e=k.get("lt_reviews")||[],i={...t,id:Date.now(),createdAt:new Date().toISOString()};return e.unshift(i),k.set("lt_reviews",e),i}function Me(t){const e=k.get("lt_bookings")||[],i={...t,id:`LT-${Date.now()}`,status:"confirmed",createdAt:new Date().toISOString()};return e.unshift(i),k.set("lt_bookings",e),k.set("lt_last_booking",i),i}function Ae(){const t=C();return t?(k.get("lt_bookings")||[]).filter(i=>i.userId===t.id):[]}function Pe(){return k.get("lt_last_booking")}function se(){return k.get("lt_wishlist")||[]}function be(t){const e=se(),i=e.indexOf(t);return i===-1?e.push(t):e.splice(i,1),k.set("lt_wishlist",e),e.includes(t)}function xe(t){return se().includes(t)}function u(t,e="",i="success"){let a=document.querySelector(".toast");a||(a=document.createElement("div"),a.className="toast",document.body.appendChild(a)),a.className=`toast ${i}`,a.innerHTML=`<div class="toast-title">${i==="success"?"✅":"❌"} ${t}</div>${e?`<div class="toast-msg">${e}</div>`:""}`,a.classList.add("show"),setTimeout(()=>a.classList.remove("show"),4e3)}function T(t){return Array.from({length:5},(e,i)=>`<span style="color:${i<Math.round(t)?"#fbbf24":"#334155"};font-size:0.9rem">★</span>`).join("")}function we(t){return t.length?(t.reduce((e,i)=>e+i.rating,0)/t.length).toFixed(1):0}function de(){window.scrollTo({top:0,behavior:"smooth"})}function ce(){var s,o,d;const t=document.getElementById("navbar-container"),e=C(),i=I;t.innerHTML=`
  ...
  `,window.addEventListener("scroll",()=>{var n;(n=document.getElementById("navbar"))==null||n.classList.toggle("scrolled",window.scrollY>30)}),(s=document.getElementById("hamburger"))==null||s.addEventListener("click",()=>{var n;(n=document.getElementById("mobile-menu"))==null||n.classList.toggle("open")}),(o=document.getElementById("nav-user-btn"))==null||o.addEventListener("click",()=>{var c;const n=document.createElement("div");n.style.cssText="position:fixed;top:70px;right:24px;background:var(--bg2);border:1px solid var(--glass-border);border-radius:var(--radius);padding:8px;z-index:2000;min-width:180px;animation:fadeIn 0.2s ease",n.innerHTML=`
    ...
    `,document.body.appendChild(n),n.querySelectorAll("[data-link]").forEach(p=>{p.addEventListener("click",m=>{m.preventDefault(),window.router.navigate(p.getAttribute("href")),n.remove()})}),setTimeout(()=>document.addEventListener("click",()=>n.remove(),{once:!0}),100),(c=n.querySelector("#dd-logout"))==null||c.addEventListener("click",()=>{te()})}),(d=document.getElementById("mobile-logout"))==null||d.addEventListener("click",n=>{n.preventDefault(),te()});const a=_(location.pathname);document.querySelectorAll(".nav-links a, .mobile-menu a").forEach(n=>{const c=n.getAttribute("href");if(!c||c==="#")return;_(new URL(c,window.location.origin).pathname)===a&&n.classList.add("active")})}function Ce(){const t=document.getElementById("footer-container"),e=I;t.innerHTML=`
    <footer id="footer">
      <div class="container">
          ...
          ${e.map(i=>`
            <div class="card destination-card animate-in" data-href="/destination/${i.id}">
              <div class="card-img-wrap">
                ...
                <div class="card-rating">${T(i.rating)} <span>${i.rating}</span></div>
              </div>
              <div class="card-body">
  ...
  `}function Ge(){const t=document.querySelector(".hero-bg");if(t){const e="/LushaiTravels/".replace(/\/$/,"");t.style.backgroundImage=`url('${e}/images/digilife-siaha-2cM78THYc4w-unsplash.jpg')`}document.querySelectorAll("[data-href]").forEach(e=>{e.addEventListener("click",()=>window.router.navigate(e.dataset.href))}),De(async()=>{const{stays:e}=await Promise.resolve().then(()=>_e);return{stays:e}},void 0).then(({stays:e})=>{const i=document.getElementById("home-stays-grid");i&&(i.innerHTML=e.slice(0,3).map(a=>`
    ...
    `).join(""),document.querySelectorAll(".stay-card[data-href]").forEach(a=>{a.addEventListener("click",()=>window.router.navigate(a.dataset.href))}))})}let J="all",O="";function We(){return`
  ...
  `).join(""),e.querySelectorAll("[data-href]").forEach(i=>{i.addEventListener("click",()=>window.router.navigate(i.dataset.href))}))}function Oe(t){const e={Easy:"#10b981",Moderate:"#f59e0b",Hard:"#ef4444"}[t.difficulty]||"#94a3b8";return`
    <div class="card destination-card animate-in" data-href="/destination/${t.id}">
      <div class="card-img-wrap">
        ...
        <div class="card-rating">${T(t.rating)} <span>${t.rating} (${t.reviews})</span></div>
      </div>
      <div class="card-body">
  ...
  `}function Qe(t){const e=I,i=G.find(o=>o.id===t);if(!i)return'<div class="page-hero container"><h1>Destination not found</h1></div>';const a=H.filter(o=>o.location.toLowerCase().includes(i.district.toLowerCase())).slice(0,2),r=Z(`dest-${t}`),s=we(r);return`
    <!-- Gallery Hero -->
      ...
      <div class="detail-layout">
        ...
        <div>
          ...
          <div style="display:flex;flex-wrap:wrap;gap:12px;align-items:center;margin-bottom:20px">
            <div style="display:flex;gap:4px;align-items:center">${T(i.rating)} <strong>${i.rating}</strong> <span style="color:var(--text-muted)">(${i.reviews} reviews)</span></div>
  ...
  `}function Xe(t){var r,s,o,d,n,c;const e=G.find(p=>p.id===t);if(!e)return;setTimeout(()=>{const p=document.getElementById("dest-map");if(!p||p._leaflet_id)return;const m=L.map("dest-map").setView([e.lat,e.lng],11);L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:"© OpenStreetMap"}).addTo(m),L.marker([e.lat,e.lng]).addTo(m).bindPopup(`<b>${e.name}</b><br>${e.district} District`).openPopup()},100);const i=e.images;let a=0;window.openLightbox=p=>{a=p,document.getElementById("lb-img").src=i[a],document.getElementById("lightbox").classList.add("open")},(r=document.getElementById("lb-close"))==null||r.addEventListener("click",()=>document.getElementById("lightbox").classList.remove("open")),(s=document.getElementById("lb-prev"))==null||s.addEventListener("click",()=>{a=(a-1+i.length)%i.length,document.getElementById("lb-img").src=i[a]}),(o=document.getElementById("lb-next"))==null||o.addEventListener("click",()=>{a=(a+1)%i.length,document.getElementById("lb-img").src=i[a]}),(d=document.getElementById("wishlist-btn"))==null||d.addEventListener("click",()=>{const p=document.getElementById("wishlist-btn"),m=be(`dest-${t}`);p.textContent=m?"❤️":"🤍",u(m?"Added to Wishlist":"Removed from Wishlist")}),(n=document.getElementById("write-review-btn"))==null||n.addEventListener("click",()=>{if(!Y()){u("Login required","Please log in to write a review","error");return}document.getElementById("review-form").classList.toggle("hidden")}),(c=document.getElementById("submit-review-btn"))==null||c.addEventListener("click",()=>{var b,y,g;const p=parseInt(((b=document.querySelector('input[name="rating"]:checked'))==null?void 0:b.value)||0),m=(g=(y=document.getElementById("review-text"))==null?void 0:y.value)==null?void 0:g.trim();if(!p){u("Please select a rating","","error");return}if(!m){u("Please write your review","","error");return}const v=C();fe({listingId:`dest-${t}`,rating:p,text:m,userName:v.fullName||v.name,userAvatar:v.avatar}),u("Review submitted! ⭐"),document.getElementById("review-form").classList.add("hidden");const x=Z(`dest-${t}`);document.getElementById("reviews-list").innerHTML=x.map(h=>ke(h)).join("")}),document.querySelectorAll("[data-href]").forEach(p=>{p.addEventListener("click",()=>window.router.navigate(p.dataset.href))})}function ke(t){var e;return`
    <div class="review-card">
      <div class="review-header">
        ...
        <div style="margin-left:auto">${T(t.rating)}</div>
      </div>
  ...
  `}function tt(){let t="all";const e=()=>{const i=t==="all"?H:H.filter(a=>a.type.toLowerCase()===t);document.getElementById("stays-grid").innerHTML=i.map(it).join(""),document.querySelectorAll("[data-href]").forEach(a=>a.addEventListener("click",()=>window.router.navigate(a.dataset.href)))};e(),document.querySelectorAll(".chip[data-type]").forEach(i=>{i.addEventListener("click",()=>{document.querySelectorAll(".chip[data-type]").forEach(a=>a.classList.remove("active")),i.classList.add("active"),t=i.dataset.type,e()})})}function it(t){return`
  ...
  `}function at(t){const e=H.find(r=>r.id===t);if(!e)return'<div class="page-hero container"><h1>Stay not found</h1></div>';const i=Z(t),a=we(i);return`
    <div style="padding-top:76px">
      <!-- Gallery -->
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;flex-wrap:wrap;gap:12px">
          <div>
            ...
            <div style="display:flex;flex-wrap:wrap;gap:12px;align-items:center;font-size:0.9rem;color:var(--text-muted)">
              ${T(a>0?a:e.rating)} <strong style="color:var(--text)">${a>0?a:e.rating}</strong>
          ...
          <div>
            <div class="booking-widget">
              <div class="booking-price">
                ...
                <div style="display:flex;gap:4px;margin-top:6px">${T(a>0?a:e.rating)} <span style="font-size:0.85rem;color:var(--text-muted)">${i.length||e.reviews} reviews</span></div>
              </div>
          ...
          <div>
            ...
            <div class="grid-2">
              <div class="form-group">
                ...
                <input type="text" class="form-input" id="pay-name" placeholder="Your full name" value="${((m=C())==null?void 0:m.fullName)||((v=C())==null?void 0:v.name)||""}" />
              </div>
              <div class="form-group">
                <label class="form-label">Email</label>
                <input type="email" class="form-input" id="pay-email" placeholder="email@example.com" value="${((x=C())==null?void 0:x.email)||""}" />
              </div>
              <div class="form-group">
                <label class="form-label">Phone</label>
                <input type="tel" class="form-input" id="pay-phone" placeholder="+91 98765 43210" value="${((b=C())==null?void 0:b.phone)||""}" />
              </div>
              <div class="form-group">
            ...
            <button class="btn btn-primary btn-lg w-full" id="pay-btn" style="justify-content:center;font-size:1.1rem" ${Y()?"":'disabled style="opacity:0.5;cursor:not-allowed;justify-content:center;font-size:1.1rem"'}>
  ...
  `}function ht(t,e){var c;const i=parseInt(e.get("total")||2e3),a=e.get("checkin")||"",r=e.get("checkout")||"",s=e.get("guests")||"1",o=e.get("type")||"stay",d=e.get("name")?decodeURIComponent(e.get("name")):t,n=H.find(p=>p.id===t);(c=document.getElementById("pay-btn"))==null||c.addEventListener("click",()=>{var h,w,$,z,E,M,j;if(!Y()){u("Please log in first","","error");return}const p=(w=(h=document.getElementById("pay-name"))==null?void 0:h.value)==null?void 0:w.trim(),m=(z=($=document.getElementById("pay-email"))==null?void 0:$.value)==null?void 0:z.trim(),v=(M=(E=document.getElementById("pay-phone"))==null?void 0:E.value)==null?void 0:M.trim();if(!p||!m||!v){u("Please fill all fields","","error");return}const b={userId:C().id,listingId:t,listingName:(n==null?void 0:n.name)||d,listingType:o,checkin:a,checkout:r,guests:s,total:i,guestName:p,guestEmail:m,guestPhone:v,notes:((j=document.getElementById("pay-notes"))==null?void 0:j.value)||""},y=Math.max(i,100);if(i<1){u("Invalid amount","Booking amount must be at least ₹1","error");return}const g={key:gt,amount:y*100,currency:"INR",name:"LushaiTrips",description:(n==null?void 0:n.name)||d,image:"https://images.unsplash.com/photo-1566073771259-6a8506099945?w=100&q=80",prefill:{name:p,email:m,contact:v},theme:{color:"#059669"},handler:function(S){const B=Me({...b,razorpayPaymentId:S.razorpay_payment_id});u("Payment Successful! 🎉",`Ref: ${B.id}`),setTimeout(()=>window.router.navigate("/booking-confirmed"),800)},modal:{ondismiss:()=>u("Payment cancelled","You closed the payment window","error"),escape:!0,animation:!0}};try{const S=new Razorpay(g);S.on("payment.failed",function(B){var P,N,W;const q=((P=B.error)==null?void 0:P.description)||((N=B.error)==null?void 0:N.reason)||"Unknown error",D=((W=B.error)==null?void 0:W.code)||"";u("Payment Failed ❌",`${q}${D?" ("+D+")":""}`,"error"),console.error("Razorpay payment failed:",B.error)}),S.open()}catch(S){console.error("Razorpay init error:",S),u("Razorpay not loaded","Please check your internet connection and try again","error")}})}function yt(){var i;const t=I,e=Pe();return`
    ...
    <div style="min-height:100vh;padding:100px 24px 60px;background:linear-gradient(135deg,var(--bg) 0%,var(--bg2) 50%,var(--bg3) 100%)">
      <div style="max-width:700px;margin:0 auto">
        ...
        <div style="display:flex;justify-content:space-between;margin-top:24px">
          ...
          <div style="color:var(--text-dim);font-size:0.85rem;align-self:center">Step ${A} of ${V}</div>
          <button class="btn btn-primary" id="next-btn">${A===V?"🚀 Submit Listing":"Next →"}</button>
        </div>
      </div>
    </div>
  `}function $e(){return Array.from({length:V},(t,e)=>{const i=e+1;return`
      <div class="step ${i<A?"done":i===A?"active":""}">
        <div class="step-wrapper">
          <div class="step-circle">${i<A?"✓":i}</div>
          <div class="step-label">${$t[e]}</div>
        </div>
      </div>
      ${i<V?'<div class="step-line"></div>':""}
    `}).join("")}function ze(t){switch(t){case 1:return`
      ...
      <div id="photo-count" style="margin-top:10px;font-size:0.85rem;color:var(--text-muted)">${R.length>0?R.length+" photo(s) uploaded":"No photos uploaded yet"}</div>`;case 5:return`
      ...
      </label>`}}function Et(t){var e,i,a,r,s,o,d,n,c,p,m,v,x,b,y,g,h,w,$,z,E,M,j,S,B,q,D,P,N;switch(t){case 1:l.name=(i=(e=document.getElementById("h-name"))==null?void 0:e.value)==null?void 0:i.trim(),l.email=(r=(a=document.getElementById("h-email"))==null?void 0:a.value)==null?void 0:r.trim(),l.phone=(o=(s=document.getElementById("h-phone"))==null?void 0:s.value)==null?void 0:o.trim(),l.password=(d=document.getElementById("h-password"))==null?void 0:d.value;const W=(n=document.getElementById("h-confirm"))==null?void 0:n.value;return!l.name||!l.email||!l.phone||!l.password?(u("Please fill all required fields","","error"),!1):l.password!==W?(u("Passwords do not match","","error"),!1):l.password.length<8?(u("Password must be 8+ characters","","error"),!1):!0;case 2:return l.propName=(p=(c=document.getElementById("h-prop-name"))==null?void 0:c.value)==null?void 0:p.trim(),l.propType=(m=document.querySelector('input[name="prop-type"]:checked'))==null?void 0:m.value,l.address=(x=(v=document.getElementById("h-address"))==null?void 0:v.value)==null?void 0:x.trim(),l.district=(b=document.getElementById("h-district"))==null?void 0:b.value,l.mapsLink=(g=(y=document.getElementById("h-maps"))==null?void 0:y.value)==null?void 0:g.trim(),!l.propName||!l.propType||!l.address||!l.district?(u("Please fill all required fields","","error"),!1):!0;case 3:return l.rooms=(h=document.getElementById("h-rooms"))==null?void 0:h.value,l.maxGuests=(w=document.getElementById("h-guests"))==null?void 0:w.value,l.price=($=document.getElementById("h-price"))==null?void 0:$.value,l.amenities=[...document.querySelectorAll('input[name="amenity"]:checked')].map(F=>F.value),l.description=(E=(z=document.getElementById("h-description"))==null?void 0:z.value)==null?void 0:E.trim(),l.nearby=(j=(M=document.getElementById("h-nearby"))==null?void 0:M.value)==null?void 0:j.trim(),!l.rooms||!l.maxGuests||!l.price||!l.description?(u("Please fill all required fields","","error"),!1):!0;case 4:return R.length<3?(u("Please upload at least 3 photos","","error"),!1):(l.images=R,!0);case 5:return l.checkIn=(S=document.getElementById("h-checkin"))==null?void 0:S.value,l.checkOut=(B=document.getElementById("h-checkout"))==null?void 0:B.value,l.rules=(D=(q=document.getElementById("h-rules"))==null?void 0:q.value)==null?void 0:D.trim(),l.cancellation=(P=document.getElementById("h-cancel"))==null?void 0:P.value,(N=document.getElementById("h-agree"))!=null&&N.checked?!0:(u("Please agree to Terms & Conditions","","error"),!1)}}function ue(t){A=t,document.getElementById("stepper").innerHTML=$e(),document.getElementById("step-container").innerHTML=ze(t),document.getElementById("prev-btn").style.visibility=t===1?"hidden":"visible",document.getElementById("next-btn").textContent=t===V?"🚀 Submit Listing":"Next →",Ee(t),window.scrollTo({top:0,behavior:"smooth"})}function Ee(t){var e;t===4&&((e=document.getElementById("photo-input"))==null||e.addEventListener("change",i=>{[...i.target.files].forEach(r=>{const s=new FileReader;s.onload=o=>{var m;R.push(o.target.result);const d=document.getElementById("photo-preview"),n=document.getElementById("photo-count"),c=document.createElement("div");c.className="upload-img-wrap";const p=R.length-1;c.innerHTML=`<img src="${o.target.result}" alt="upload" />${p===0?'<div style="position:absolute;bottom:4px;left:4px;background:rgba(16,185,129,0.9);color:#fff;font-size:0.65rem;padding:2px 6px;border-radius:4px;font-weight:700">COVER</div>':""}<button class="remove-img" data-idx="${p}">✕</button>`,d==null||d.appendChild(c),n&&(n.textContent=R.length+" photo(s) uploaded"),(m=c.querySelector(".remove-img"))==null||m.addEventListener("click",v=>{R.splice(p,1),c.remove(),n&&(n.textContent=R.length+" photo(s) uploaded")})},s.readAsDataURL(r)})}))}function Le(){var t,e;R=[],Ee(1),(t=document.getElementById("next-btn"))==null||t.addEventListener("click",()=>{var i,a;Et(A)&&(A===V?Lt():(ue(A+1),(i=document.getElementById("next-btn"))==null||i.addEventListener("click",()=>{}),(a=document.getElementById("prev-btn"))==null||a.addEventListener("click",()=>{}),Le()))}),(e=document.getElementById("prev-btn"))==null||e.addEventListener("click",()=>{A>1&&ue(A-1)})}function Lt(){var t,e;try{ae({name:l.name,email:l.email,phone:l.phone,password:l.password,avatar:(t=l.name)==null?void 0:t.charAt(0).toUpperCase(),listing:{name:l.propName,type:l.propType,address:l.address,district:l.district,rooms:l.rooms,maxGuests:l.maxGuests,price:l.price,amenities:l.amenities,description:l.description,images:l.images,checkIn:l.checkIn,checkOut:l.checkOut,rules:(e=l.rules)==null?void 0:e.split(`
`).filter(Boolean),cancellation:l.cancellation}}),A=1,R=[],u("Listing submitted for review! 🎉","We'll review within 48 hours."),setTimeout(()=>window.router.navigate("/host-dashboard"),800)}catch(i){u(i.message,"","error")}}let U=[];function It(){return`
    <div style="min-height:100vh;padding:100px 24px 60px;background:linear-gradient(135deg,var(--bg) 0%,var(--bg2) 50%,var(--bg3) 100%)">
  ...
  `}function St(){var t,e;U=[],(t=document.getElementById("g-photos"))==null||t.addEventListener("change",i=>{[...i.target.files].forEach(a=>{const r=new FileReader;r.onload=s=>{var n,c;U.push(s.target.result);const o=document.createElement("div");o.className="upload-img-wrap";const d=U.length-1;o.innerHTML=`<img src="${s.target.result}" alt="upload" />${d===0?'<div style="position:absolute;bottom:4px;left:4px;background:rgba(16,185,129,0.9);color:#fff;font-size:0.65rem;padding:2px 6px;border-radius:4px;font-weight:700">PROFILE</div>':""}<button class="remove-img">✕</button>`,(n=document.getElementById("g-photo-preview"))==null||n.appendChild(o),(c=o.querySelector(".remove-img"))==null||c.addEventListener("click",()=>{U.splice(d,1),o.remove()})},r.readAsDataURL(a)})}),(e=document.getElementById("submit-guide-btn"))==null||e.addEventListener("click",()=>{var b,y,g,h,w,$,z,E,M,j,S,B,q,D,P,N,W;const i=(y=(b=document.getElementById("g-name"))==null?void 0:b.value)==null?void 0:y.trim(),a=(h=(g=document.getElementById("g-email"))==null?void 0:g.value)==null?void 0:h.trim(),r=($=(w=document.getElementById("g-phone"))==null?void 0:w.value)==null?void 0:$.trim(),s=(z=document.getElementById("g-password"))==null?void 0:z.value,o=(M=(E=document.getElementById("g-title"))==null?void 0:E.value)==null?void 0:M.trim(),d=(S=(j=document.getElementById("g-bio"))==null?void 0:j.value)==null?void 0:S.trim(),n=(B=document.getElementById("g-price"))==null?void 0:B.value,c=(q=document.getElementById("g-location"))==null?void 0:q.value,p=(D=document.getElementById("g-exp"))==null?void 0:D.value,m=[...document.querySelectorAll('input[name="g-lang"]:checked')].map(F=>F.value),v=[...document.querySelectorAll('input[name="g-spec"]:checked')].map(F=>F.value),x=(N=(P=document.getElementById("g-certs"))==null?void 0:P.value)==null?void 0:N.split(`
`).filter(Boolean);if(!i||!a||!r||!s||!o||!d||!n||!c||!p||!m.length||!v.length){u("Please fill all required fields","","error");return}if(!((W=document.getElementById("g-agree"))!=null&&W.checked)){u("Please agree to Terms","","error");return}try{ae({name:i,email:a,phone:r,password:s,avatar:i.charAt(0).toUpperCase(),listing:{type:"guide",title:o,experience:p,languages:m,specialties:v,price:n,location:c,bio:d,certifications:x,images:U}}),u("Guide application submitted! 🎉","We'll review within 48 hours."),setTimeout(()=>window.router.navigate("/host-dashboard"),800)}catch(F){u(F.message,"","error")}})}function Bt(){return`
    <div style="min-height:100vh;padding:100px 24px 60px;background:linear-gradient(135deg,var(--bg) 0%,var(--bg2) 50%,var(--bg3) 100%)">
      <div style="max-width:680px;margin:0 auto">
        <div style="text-align:center;margin-bottom:40px">
          <div class="auth-logo" style="font-size:2rem;margin-bottom:8px">LushaiTrips</div>
